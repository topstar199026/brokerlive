                ...
                <div class="ibox-content">
					<div class="table-responsive">
						<table class="table table-bordered table-striped table-hover table-team m-b-xs clearfix">
							...
							<tbody>
								@foreach($reportData['all'] as $key=>$row)
            					<tr>
									<td>{{$key}}</td>
									<td>{{$row->leads}}</td>
									...
									<td>{{$row->appts}}</td>
									<td>{{$DashboardService->conversionRate($row->submissions_number, $row->appts)}}%</td>
					...
					@foreach($reportData['ym'] as $key=>$val)
					<div class="table-responsive">
						<table class="table table-bordered table-striped table-hover table-team m-b-xs clearfix">
							<thead>
								<tr>
									<th colspan="17">Month: {{$key}}</th>
								</tr>
								<tr>
									<th>Broker</th>
									<th>Leads</th>
