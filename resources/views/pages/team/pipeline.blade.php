        ...
        <div class="col-md-12">
            ...
            <div class="ibox m-b-xs float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
						<a class="export-link" href="{{url('team/csv?section=committed&type='.$page_type)}}">
                            <i class="fa fa-file-excel-o"></i>
                        </a>
                        <a class="collapse-link" data-tableid="2">
                            <i class="fa fa-chevron-up"></i>
                ...
                <div class="ibox-content">
                    @include('pages.team.table', ['section' => $committedSection])
                </div>
            </div>
            <div class="ibox m-b-xs float-e-margins">
                <div class="ibox-title">
                    <h5>Hot Clients</h5>
                    <div class="ibox-tools">
						<a class="export-link" href="{{url('team/csv?section=hot&type='.$page_type)}}">
                            <i class="fa fa-file-excel-o"></i>
                        </a>
                        <a class="collapse-link" data-tableid="2">
                            <i class="fa fa-chevron-up"></i>
                ...
                <div class="ibox-content">
                    @include('pages.team.table', ['section' => $hotSection])
                </div>
            </div>
            <div class="ibox m-b-xs float-e-margins">
                <div class="ibox-title">
