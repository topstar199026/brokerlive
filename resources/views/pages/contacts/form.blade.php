...
<div class="loansplit-form">
    ...
    <div class="ibox-tools" style="top: 25px;right: 35px;">
        <a title="Add Contact" class="btn btn-white useradd" href="/contact/create"><i class="fa fa-tasks"></i> Add</a>
    </div>
    <hr/>
    ...
    <div class="tab-content">
        <div id="detail" class="tab-pane active">
            <br/>
            <form name="contactForm" id="contactForm" method="post" action="/contact/edit/{{$contact->id}}" class="form-horizontal" data-parsley-validate="" novalidate="">
                ...
                <div class="form-actions clearfix" style="padding-bottom: 50px;">
                    <div class="pull-right">
                        <a class="btn btn-info btn-xs btn-cancel" href="/contact/"><i class="fa fa-times-circle"></i> Cancel</a>
                        <button type="button" id="save_btn" class="btn btn-primary btn-xs btn-save"><i class="fa fa-save"></i> Save</button>
                        @php
                        if ($contact->id != '') { 
                        @endphp
                            <a class="btn btn-danger btn-xs btn-delete" onclick="validateContact('{{$contact->id}}', '/contact/delete/{{$contact->id}}')" ><i class="fa fa-trash-o"></i> Delete</a>
                        @php
                        }
                        @endphp
                    </div>
