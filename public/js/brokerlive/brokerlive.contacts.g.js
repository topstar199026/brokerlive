...
$(document).ready(function(){
    ...
    $('.table-contact').each(function (e) {
        ...
        dataTable[contactType] = table
            .DataTable( {
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "/data/v1/gcontact/datatable?contact_type=" + contactType,
                "columns": [
                    { "data": "id" },
                    {
                        "data": "name",
                        "render": function(data, type, row, meta) {
                            return "<a href='/gcontact/edit/" + row.id + "' class='client-link'>" + (row.firstname + ' ' + row.lastname) + "</a>";
                        }
                    },
                    { "data": "company" },
                    {
    ...
    autoCompleteInput
        .autocomplete({
            source: '/data/v1/gcontact/autocomplete',
            minLength: 2,
